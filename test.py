...
class ConvertTestCase(unittest.TestCase):
    ...
    def test_second_example(self):
        input = '2019-12-25T00:01:02.186716+10:00 baza.farpost.ru_log: "baza.drom.ru" 213.234.251.26 - - [25/Dec/2019:00:01:02 +1000] "GET /mmy.txt?action=viewdir_ppc_good_show__in_646&keyName=26&out=15&_=1577196056301 HTTP/1.1" "200" "0" "989" "0.000" 192.168.36.22 "-" "-" "" "a221fc6dbc42ab342eedd4bbeaafa9ab" "-" "-" "-" "https://baza.drom.ru/novosibirsk/sell_spare_parts/+/%E4%E2%E8%E3%E0%F2%E5%EB%FC+%E2+%F1%E1%EE%F0%E5/model/mazda+demio/body/dw3w/" "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36 OPR/65.0.3467.78 (Edition Yx 02)" "on" "-" "-" "-" "" "" "192.168.36.129" "80.92.164.144" "7.3.10" "-" "-"'
        csv = app.convert(input)
        self.assertEqual(
            csv,
            ['2019-12-25 00:01:02', 0, 'a221fc6dbc42ab342eedd4bbeaafa9ab', 'viewdir_ppc_good_show__in_646', 26.0,
            "[('keyName','26'),('out','15')]"])
